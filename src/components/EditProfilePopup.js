  ...
  return (
    <PopupWithForm name="person" title="Редактировать профиль" buttonText="Сохранить"
      ...
      <label className="popup__label">
        <input onChange={handleChangeName} type="text" className="form__input popup__input popup__input_person-name" name="name" defaultValue="" placeholder="Имя" minLength="2" maxLength="40" required autoComplete="off"/>
